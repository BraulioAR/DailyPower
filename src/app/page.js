     ...
     <Heroo/>
      ...
      <div className="w-full h-full max-w-7xl mx-auto">
        ...
        <h1 className="text-[#F5F5F5] font-bold text-[42px] leading-[50.4px] text-center lg:text-start ">Para más información:</h1>
          <button className="border-[4px] border-[#E73516] bg-transparent text-[#E73516] hover:text-white hover:scale-105 hover:bg-[#E73516] py-3 text-[14px] font-bold leading-[23.8px] px-14">CONTÁCTENOS</button>
          </div>
          </div>
      </div>
    </main>
