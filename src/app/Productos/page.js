  ...
  return (
    ...
    <div className="relative pt-20 lg:mt-24">
      <div className="lg:pb-80 pt-16  sm:pt-24 pb-24 lg:pt-40">
        ...
        <a href="#" className='rounded-md p-4 text-[#E73516] bg-transparent border shadow border-[#E73516] hover:text-white hover:bg-[#E73516] lg:w-52 flex justify-center items-center'>Baterías</a>
        <a href="#" className='rounded-md p-4 text-[#E73516] bg-transparent border shadow border-[#E73516] hover:text-white hover:bg-[#E73516] lg:w-52 flex justify-center items-center'>Inversores</a>
        <a href="#" className='rounded-md p-4 text-[#E73516] bg-transparent border shadow border-[#E73516] hover:text-white hover:bg-[#E73516] lg:w-52 flex justify-center items-center'>Paneles Solares</a>
              <a href="#" className='rounded-md p-4 text-[#E73516] bg-transparent border shadow border-[#E73516] hover:text-white hover:bg-[#E73516] lg:w-52 flex justify-center text-center '>Estructuras de Montaje</a>
        </div>
              </div>
                <div id="products" className="relative isolate z-50 px-6 lg:px-8 transition-transform duration-500 ">
